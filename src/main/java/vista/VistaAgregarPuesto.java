...
public class VistaAgregarPuesto extends javax.swing.JFrame {
    ...
    public void llenarComboBox() {
    	...
    	for (Consola c : consolas) {
			jComboBox1.addItem(c.getConsola());
		}
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnListaUsuarios, javax.swing.GroupLayout.DEFAULT_SIZE, 229, Short.MAX_VALUE)
        ...
        jLabel8.setText("Cantidad de sillas:");

        jLabel9.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        jLabel9.setText("Cantidad de controles:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Consola", "Ps4", "Ps3", "Xbox series S", "Xbox One", "WiiU", "Nintendo Switch", "Ps5" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sillas", "1", "2", "3", "4" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Controles", "1", "2", "3", "4" }));
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel5Layout.createSequentialGroup()
                                        .addGap(21, 21, 21)
                                        .addComponent(txtNumeroPuesto, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(jPanel5Layout.createSequentialGroup()
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) throws Exception {                                          
    	if(!(txtNumeroPuesto.getText().isEmpty())) {
			...
			if(puestoBuscado != null) {
				...
				txtNumeroPuesto.setText(puestoBuscado.getNumeroDePuesto());
			}else {
    		...
    		if(!(txtId.getText().isEmpty())) {
    			...
    			Puesto puestoBuscado = puesto.buscarPuestoPorId(id);
    			if(puestoBuscado != null) {
    				JOptionPane.showMessageDialog(null, "El puesto fue encontrado");
    				txtNumeroPuesto.setText(puestoBuscado.getNumeroDePuesto());
    			}else {
    ...
    public void llenarTabla() {
        ...
        modelo.setColumnIdentifiers(new Object[]{"Id","Numero de puesto", "Consola", "Cantidad de sillas", "Cantidad de controles"});
